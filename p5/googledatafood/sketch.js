...
function setup() {
  ...
  tacos = loadImage("assets/tacos.jpg");
  spaghetti = loadImage("assets/spaghetti.png");
  burger = loadImage("assets/burger.jpeg");
...
function Circle(myName, myShape) {
  ...
  if(this.name == "Italian Beef") {
  image(beef, this.pos.x, this.pos.y, 100, 100);
  }
  ...
  if(this.name == "Hamburger") {
  image(burger, this.pos.x, this.pos.y, 100, 100);
  }

  if(this.name == "Chicken") {
  image(chicken, this.pos.x, this.pos.y, 100, 100);
  }

  if(this.name == "Spaghetti") {
  image(spaghetti, this.pos.x, this.pos.y, 100, 100);
  }

  if(this.name == "Hot Dog") {
  image(dog, this.pos.x, this.pos.y, 100, 100);
  }

  if(this.name == "Ice Cream") {
  image(ice, this.pos.x, this.pos.y, 100, 100);
  }

    if(this.name == "Steak") {
    image(steak, this.pos.x, this.pos.y, 100, 100);
  }
